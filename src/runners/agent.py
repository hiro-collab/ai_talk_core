"""CLI bridge for piping the latest handoff prompt into an external agent or command."""
...
def build_parser() -> argparse.ArgumentParser:
    """Build the shared agent runner CLI parser."""
...
def main() -> int:
    """Run the shared agent handoff runner."""
